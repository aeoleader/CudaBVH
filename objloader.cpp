	...
	if(fp_in.is_open()){
        while (fp_in.good() ){
			...
			if(line[0]=='v' && line[1]=='t'){
				...
				getline(liness, y, ' ');
				getline(liness, z, ' ');
				geomesh->addTextureCoord(Vector3(::atof(x.c_str()), ::atof(y.c_str()), ::atof(z.c_str())));
				...
				getline(liness, y, ' ');
				getline(liness, z, ' ');
				geomesh->addNormal(Vector3(::atof(x.c_str()), ::atof(y.c_str()), ::atof(z.c_str())));
			}else if(line[0]=='v'){
				string v;
				string x;
				string y;
				...
				getline(liness, y, ' ');
				getline(liness, z, ' ');
				geomesh->addPoint(Vector3(::atof(x.c_str()), ::atof(y.c_str()), ::atof(z.c_str())));
			}else if(line[0]=='f'){
				string v;
				getline(liness, v, ' ');
				string delim1 = "//";
